        ...
        if '[unused' in line or new_example:
            ...
            if line is not '':
                ...
                if len(sentence.split()) == 1:
                    tokenized_words['input_ids'] = [tokenized_words['input_ids']]
    ...
    if 'predict' in hparams.mode:
        ...
        if predict_sentences == None:  # predict
            ...
            for line in predict_lines:
                ...
                predict_sentences.append(' '.join(tokenized_line))
                predict_sentences.append('\n')
        predict_examples, all_sentences = _process_data(predict_lines, hparams, fields, tokenizer, label_dict, None)
