...
# bash predict_gpu.sh ${MODEL_S1} ${INPUT} ${OUTPUT}.s1_predicted
# python make_test_s2.py --inp_s1_predictions ${OUTPUT}.s1_predicted --inp_sentences ${INPUT} --out_s2_input ${OUTPUT}  

bash predict_gpu.sh ${MODEL_S2} ${OUTPUT}.s2_input ${OUTPUT}.s2_output
...
bash score.sh ${MODEL_S2} ${OUTPUT}.scores_input ${OUTPUT}.scores_output_corr_tags
